...
export const defaultThemeSettings: ThemeSettings = {
  ...
  heroTagline: "O autêntico sabor do litoral, Refeições, Porções,\nYakisobas e muito mais!\n\nTudo feito na Hora e com muito carinho!",
  ...
  aboutText:
    "O Sabor da Praia nasceu com a paixão de levar a melhor gastronomia, pratos saborosos e porções generosas até a sua mesa.\nTudo é preparado na hora com muita qualidade e ingredientes frescos e selecionados, tempero especial que faz você sempre querer mais!",
